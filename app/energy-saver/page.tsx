        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border-2 border-transparent hover:border-green-500 transition-all">
              <div className="p-5 pb-0">
                <div className="aspect-square rounded-lg overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=400&h=400&fit=crop" alt="Risparmio bolletta" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="p-5">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border-2 border-transparent hover:border-green-500 transition-all">
              <div className="p-5 pb-0">
                <div className="aspect-square rounded-lg overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&h=400&fit=crop" alt="Elettrodomestici protetti" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="p-5">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border-2 border-transparent hover:border-green-500 transition-all">
              <div className="p-5 pb-0">
                <div className="aspect-square rounded-lg overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop" alt="Installazione facile" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="p-5">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border-2 border-transparent hover:border-green-500 transition-all">
              <div className="p-5 pb-0">
                <div className="aspect-square rounded-lg overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=400&h=400&fit=crop" alt="Smartphone in carica" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="p-5">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border-2 border-transparent hover:border-green-500 transition-all">
              <div className="p-5 pb-0">
                <div className="aspect-square rounded-lg overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1605727216801-e27ce1d0cc28?w=400&h=400&fit=crop" alt="Protezione temporali" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="p-5">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border-2 border-transparent hover:border-green-500 transition-all">
              <div className="p-5 pb-0">
                <div className="aspect-square rounded-lg overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=400&h=400&fit=crop" alt="Sostenibilità ambientale" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="p-5">
