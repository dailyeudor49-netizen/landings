...
export default function ThankYouEnergySaver() {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          I tuoi 2 Energy Saver Pro sono in preparazione e saranno spediti a breve. Preparati a risparmiare sulla bolletta!
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Consegna e risparmio</div>
        ...
        <div style={{
          ...
          <div style={{ fontWeight: 700, color: '#047857', fontSize: '1rem', marginBottom: '0.25rem' }}>
            Il tuo risparmio previsto:
          </div>
          <div style={{ color: '#065F46', fontSize: '0.85rem' }}>
            Fino a <strong>€50-100/mese</strong> in meno sulla bolletta
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Pagamento alla consegna: €49</div>
