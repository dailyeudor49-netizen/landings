    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          A Smart Aerial TV készülékét előkészítjük és hamarosan postázzuk.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>RENDELÉSI SZÁM</div>
